...
struct NewCollectionView: View {
    ...
    var body: some View {
        ScrollView {
            Text("New Collection")
                .bold()
                .font(
                    .custom(settings.fontChoice, size: 30, relativeTo: .title)
                )
            ...
            HStack {
                ...
                TextField(
                    "", text: $cName,
                    prompt: Text("Collection Name").foregroundStyle(
            ...
            Text("Item Fields")
                ...
                .font(
                    .custom(
                        settings.fontChoice, size: 24, relativeTo: .subheadline)
                )
                .foregroundStyle(Color(settings.textColor))
            Text(
            ...
            HStack {
                ...
                TextField(
                    "", text: $iName,
                    prompt: Text("Item Name").foregroundStyle(
                        Color(settings.textColor).opacity(0.5))
                )
                .font(.custom(settings.fontChoice, size: 16, relativeTo: .body))
                .padding(5)
            ...
            HStack {
                ...
                TextField(
                    "", text: $pName,
                    prompt: Text("Photo Name").foregroundStyle(
                        Color(settings.textColor).opacity(0.5))
                )
                .font(.custom(settings.fontChoice, size: 16, relativeTo: .body))
                .padding(5)
            ...
            if count >= 1 {
                HStack {
                    TextField(
                        "", text: $oKey1,
                        prompt: Text("New Item Field").foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
    ...
    func createCollection() {
        collections.collectionArray.append(
            Collection(
                id: UUID(), name: cName, items: [Item](),
                coverImage: CodableImage(photo: cImage!), itemName: iName,
                photoName: pName, otherKey1: oKey1, otherKey2: oKey2,
                otherKey3: oKey3, otherKey4: oKey4, otherKey5: oKey5))
    }
