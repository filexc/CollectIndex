...
struct NewItemView: View {
    ...
    var body: some View {
        ScrollView {
            ...
            Text("All fields are required.")
                .font(
                    .custom(settings.fontChoice, size: 12, relativeTo: .caption)
                )
                .foregroundStyle(Color(settings.textColor))
            HStack {
                Text("*")
                ...
                TextField(
                    "", text: $iName,
                    prompt: Text(collection.itemName).foregroundStyle(
                        Color(settings.textColor).opacity(0.5))
                )
            ...
            if collection.otherKey1 != "" {
                HStack {
                    ...
                    TextField(
                        "", text: $otherValue1,
                        prompt: Text(collection.otherKey1).foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
            ...
            if collection.otherKey2 != "" {
                HStack {
                    ...
                    TextField(
                        "", text: $otherValue2,
                        prompt: Text(collection.otherKey2).foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
            ...
            if collection.otherKey3 != "" {
                HStack {
                    ...
                    TextField(
                        "", text: $otherValue3,
                        prompt: Text(collection.otherKey3).foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
            ...
            if collection.otherKey4 != "" {
                HStack {
                    ...
                    TextField(
                        "", text: $otherValue4,
                        prompt: Text(collection.otherKey4).foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
            ...
            if collection.otherKey5 != "" {
                HStack {
                    ...
                    TextField(
                        "", text: $otherValue5,
                        prompt: Text(collection.otherKey5).foregroundStyle(
                            Color(settings.textColor).opacity(0.5))
                    )
                    .font(
                        .custom(
    ...
    func createItem() {
        if collection.otherKey1 != "" {
            self.otherFields.append(
                Other(id: UUID(), key: collection.otherKey1, value: otherValue1)
            )
        }
        if collection.otherKey2 != "" {
            self.otherFields.append(
                Other(id: UUID(), key: collection.otherKey2, value: otherValue2)
            )
        }
        if collection.otherKey3 != "" {
            self.otherFields.append(
                Other(id: UUID(), key: collection.otherKey3, value: otherValue3)
            )
        }
        if collection.otherKey4 != "" {
            self.otherFields.append(
                Other(id: UUID(), key: collection.otherKey4, value: otherValue4)
            )
        }
        if collection.otherKey5 != "" {
            self.otherFields.append(
                Other(id: UUID(), key: collection.otherKey5, value: otherValue5)
            )
        }
        if let index = collections.collectionArray.firstIndex(where: {
            $0.id == collection.id
        }) {
            collections.collectionArray[index].items.append(
                Item(
                    id: UUID(), name: iName,
                    image: CodableImage(photo: iImage!),
